...
[![Vite](https://img.shields.io/badge/Vite-5.0-7C4DFF?logo=vite&logoColor=white)](https://vitejs.dev)
[![Gemini API](https://img.shields.io/badge/Gemini%20API-2.5%20Flash-8A2BE2)](https://ai.google.dev)
...
```bash
envVITE_GEMINI_API_KEY=SUA_CHAVE_AQUI
```
