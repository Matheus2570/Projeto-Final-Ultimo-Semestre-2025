  ...
  setResposta("");
    ...
    return (
      <div className="ia-container-novo">
        ...
        {/* LAYOUT 100% FLEX – ZERO GRID */}
        <div className="ia-layout-flex">
          {/* Esquerda */}
          <aside className="ia-coluna ia-coluna-esquerda">
            ...
            <div className="ia-imagem-lateral">
              <img src={imgEsquerda} alt="Esquerda" />
            </div>
          </aside>
  ...
  <div className="ia-resposta">
    ...
    <div className="markdown-content">
      <ReactMarkdown remarkPlugins={[remarkGfm]}>{resposta}</ReactMarkdown>
          ...
          {/* Direita – Categorias */}
          <aside className="ia-coluna ia-coluna-direita">
            ...
            <div className="ia-imagem-lateral">
              <img src={imgDireita} alt="Direita" />
            </div>
          </aside>
        </div>
      </div>
